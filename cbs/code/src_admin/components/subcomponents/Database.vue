...
<div>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                <el-form-item>
                    ...
                    <el-dialog title="增加数据库" :visible.sync="dialogFormVisible">
                                    <el-form :inline="true" :model="formInline" class="demo-form-inline">
                                        <el-form-item label="数据库类型">
                                            <el-select v-model="formInline.region" placeholder="数据库类型">
                                            <el-option label="MySQL" value="shanghai"></el-option>
                                            <el-option label="Redis" value="beijing"></el-option>
                                            <el-option label="MongoDB" value="beijing"></el-option>
                                            </el-select>
                                        </el-form-item>
                                        ...
                                        <el-form-item label="数据库端口号">
                                            <el-input v-model="formInline.user" placeholder="端口号"></el-input>
                                        </el-form-item>
                                        </el-form>
    ...
    <el-table-column
      label="数据库表"
      prop="info">
      <el-select v-model="formInline.region" placeholder="选择表">
      <el-option label="phoneNumber" value="shanghai"></el-option>
      <el-option label="package" value="beijing"></el-option>
    </el-select>
    </el-table-column>
    <el-table-column
      align="right">
