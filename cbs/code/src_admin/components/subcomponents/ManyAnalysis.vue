...
<script>
import VAChart from '@/components/VAcomponents/VAChart'
  ...
  data () {
    return {
      chartConfig: {
        type: 'pie',
        data: {
          labels: ['神州行', '校园行', '畅聊','大魔王','办公'],
          datasets: [{
            data: [20,8.6,28, 37.7, 4.1],
            backgroundColor: ['#00a65a', '#f39c12', '#A72828','#A72828','#00c0ef'],
            hoverBackgroundColor: ['#00a65a', '#f39c12', '#A72828','#A72828','#00c0ef']
          }]
        },
        options: {
          responsive: true,
